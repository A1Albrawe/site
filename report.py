...
<style>
    ...
    /* 🕹️ حقن وتثبيت معايير الستارة الجانبية المنبثقة دائرياً الموحدة لمنع التعليق */
    .sidebar-overlay { 
    ...
    .link-home { color: #8b949e; } .link-projects { color: #a371f7; } .link-about { color: #ff7b72; } .link-scripts { color: #58a6ff; } .link-report { color: #ff5555; } .link-telegram { color: #388bfd; }
</style>
"""
...
<body>
    ...
    <!-- الستارة الجانبية منبثقة دائرياً ومدمجة في نفس الملف لمنع تداخل الكروت نهائياً -->
